      ...
      <View style={styles.BoxBottom}>
        <View style={styles.BoxHistory}>
          <View style={styles.BoxHistoryTopText}>
            <Text style={{color: '#FF4800', fontSize: 20, fontWeight: 'bold'}}>
              Transações Recentes
            </Text>
            <TouchableOpacity>
              <Text
                style={{color: '#FF8500', fontSize: 15, fontWeight: 'bold'}}>
                Ver Tudo
              </Text>
            </TouchableOpacity>
          </View>
          <View
            ...
            <TouchableOpacity style={[styles.tagTransactionsAll, {width: 100}]}>
              ...
              />
              <Text
                style={{color: '#FF8500', fontWeight: 'bold', marginLeft: 5}}>
                Renda
              </Text>
            </TouchableOpacity>
                  ...
                  <View style={styles.transactionBoxLefContent}>
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <View style={{marginLeft: 20, width: '60%'}}>
                        <Text style={styles.textTransactionItem}>Comida</Text>
                        <Text style={styles.textTransactionItemSubtitle}>
                          Ifood
                        </Text>
                      </View>
                    </View>
                    <View>
                      <Text style={styles.textTransactionItemValue}>
                        -R$ 21,32
                      </Text>
                      <Text
                        style={[
                          styles.textTransactionItemSubtitle,
                          {textAlign: 'right'},
                        ]}>
                        8 Set
                      </Text>
                ...
                <View style={styles.transactionBoxItem}>
                  <View style={styles.transactionBoxLefContent}>
                    <View style={{flexDirection: 'row'}}>
                      ...
                      />
                      <View style={{marginLeft: 20, width: '60%'}}>
                        <Text style={styles.textTransactionItem}>
                          Transporte
                        </Text>
                        <Text style={styles.textTransactionItemSubtitle}>
                          Uber
